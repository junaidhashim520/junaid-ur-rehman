...
export const projectDetails: ProjectDetail[] = [
  ...
  },
  {
    ...
    image: "/images/project-personal-portfolio.webp",
    ...
    websites: [
      { title: "JUNAID UR REHMAN PORTFOLIO", type: "PERSONAL BRAND PORTFOLIO", image: "/images/project-personal-portfolio.webp", summary: "A modern portfolio presenting automation, web development, services, skills, résumé, and direct contact options within a confident personal brand.", features: ["Service-led hero", "Personal brand identity", "Portfolio navigation", "WhatsApp contact path"] },
      { title: "AUTOMOTIVE COURSE WEBSITE", type: "ONLINE LEARNING EXPERIENCE", image: "/images/project-automotive-courses.webp", summary: "An automotive learning landing experience using a strong vehicle-led hero, simple course discovery, and prominent enrollment actions.", features: ["Course discovery", "Automotive visual direction", "Clear navigation", "Enrollment call to action"] },
      { title: "PRIME HOME REAL ESTATE", type: "PROPERTY DISCOVERY WEBSITE", image: "/images/project-prime-home.webp", summary: "A property platform combining an aspirational real-estate hero with location, property-type, and price filters for faster discovery.", features: ["Property search filters", "Listing navigation", "Agent contact path", "List-property action"] },
      { title: "FITNESS ARENA GYM", type: "LOCAL FITNESS WEBSITE", image: "/images/project-fitness-arena.webp", summary: "A high-energy gym website connecting the brand promise with memberships, services, trainers, schedules, gallery content, and WhatsApp enquiries.", features: ["Membership journey", "Trainer and schedule sections", "Location details", "WhatsApp conversion"] },
    ],
  },
  {
